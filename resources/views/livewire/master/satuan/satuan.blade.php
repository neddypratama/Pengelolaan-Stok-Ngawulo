...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('entri-satuan') }}" class="d-none d-sm-inline-block btn btn-md btn-primary shadow-sm rounded-pill" wire:navigate><i
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold "><i class="fas fa-box mr-3"></i>Data Satuan</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($satuans as $satuan)
                            <tr>
                                ...
                                <td class=" align-middle " style="width: 80%">{{ $satuan->nama_satuan }}</td>
                                <td class="align-middle text-center">
                                    <a href="{{ route('edit-satuan', $satuan->id_satuan) }}"
                                        class="btn btn-warning mr-1 rounded-circle" data-bs-toggle="tooltip"
                                        data-bs-title="Edit Data" wire:navigate>
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <button wire:click.prevent="confirmDelete({{ $satuan->id_satuan }})"
